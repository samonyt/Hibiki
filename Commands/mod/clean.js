    ...
    async run(msg, { filter, limit, member }) {
        ...
        if (filter) {
            ...
            const embed = new MessageEmbed()
                .setColor(0xff0000)
                .setDescription(this.client.translate('commands.clean.embed.response', limit, this.client.modules.Filter ? this.client.modules.Filter(filter) : 'None', msg.author.tag));
        ...
        const embed = new MessageEmbed()
            .setColor(0xff0000)
            .setDescription(this.client.translate('commands.clean.embed.responseAlt', limit, msg.channel.name, this.client.modules.Filter ? this.client.modules.Filter(filter) : 'None', msg.author.tag));
        await modlog.send({ embed });
        return null;
    }
};
